...
A structured guide through all 44 Scratch LLM implementations.
...
**10. `02-alignment/microreinforce.py`**
...
**12. `03-systems/microattention.py`**
...
**20. `03-systems/microdiscretize.py`**
...
**21. `03-systems/microcomplexssm.py`**
...
**22. `03-systems/microroofline.py`**
...
**25. `01-foundations/microdiffusion.py`**
...
**26. `01-foundations/microembedding.py`**
...
**28. `01-foundations/microtokenizer.py`**
