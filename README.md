...
| --- | ------------------------------------------ | ------ | -------- |
| 1   | [Tokenizer](foundations/microtokenizer.py) | 30 min | - [x]    |
| 2   | [Embedding](foundations/microembedding.py) | 40 min | - [x]    |
...
| #   | Script                                             | Time   | Checkbox |
| --- | -------------------------------------------------- | ------ | -------- |
| 3   | [Optimizer](foundations/microoptimizer.py)         | 45 min | - [ ]    |
| 4   | [Batch Normalization](alignment/microbatchnorm.py) | 25 min | - [ ]    |
| 5   | [DropOut](alignment/microdropout.py)               | 25 min | - [ ]    |
...
| #   | Script                         | Time   | Checkbox |
| --- | ------------------------------ | ------ | -------- |
| 6   | [RNN](foundations/micrornn.py) | 45 min | - [ ]    |
| 7   | [GPT](foundations/microgpt.py) | 60 min | - [ ]    |
...
| #   | Script                                  | Time   | Checkbox |
| --- | --------------------------------------- | ------ | -------- |
| 8   | [BERT](foundations/microbert.py)        | 45 min | - [ ]    |
| 9   | [Convolution](foundations/microconv.py) | 45 min | - [ ]    |
...
| #   | Script                         | Time   | Checkbox |
| --- | ------------------------------ | ------ | -------- |
| 10  | [RAG](foundations/microrag.py) | 50 min | - [ ]    |
...
| #   | Script                                     | Time   | Checkbox |
| --- | ------------------------------------------ | ------ | -------- |
| 11  | [VAE](foundations/microvae.py)             | 50 min | - [ ]    |
| 12  | [GAN](foundations/microgan.py)             | 50 min | - [ ]    |
| 13  | [Diffusion](foundations/microdiffusion.py) | 60 min | - [ ]    |
...
| #   | Script                           | Time   | Checkbox |
| --- | -------------------------------- | ------ | -------- |
| 14  | [LoRA](alignment/microlora.py)   | 35 min | - [ ]    |
| 15  | [QLoRA](alignment/microqlora.py) | 35 min | - [ ]    |
...
| #   | Script                                   | Time   | Checkbox |
| --- | ---------------------------------------- | ------ | -------- |
| 16  | [DPO](alignment/microdpo.py)             | 40 min | - [ ]    |
| 17  | [Reinforce](alignment/microreinforce.py) | 35 min | - [ ]    |
| 18  | [PPO](alignment/microppo.py)             | 35 min | - [ ]    |
| 19  | [GRPO](alignment/microgrpo.py)           | 35 min | - [ ]    |
...
| #   | Script                       | Time   | Checkbox |
| --- | ---------------------------- | ------ | -------- |
| 20  | [MOE](alignment/micromoe.py) | 35 min | - [ ]    |
...
| #   | Script                                   | Time   | Checkbox |
| --- | ---------------------------------------- | ------ | -------- |
| 21  | [Attention](systems/microattention.py)   | 40 min | - [ ]    |
| 22  | [Flash Attention](systems/microflash.py) | 40 min | - [ ]    |
| 23  | [ROPE](systems/microrope.py)             | 35 min | - [ ]    |
...
| #   | Script                                   | Time   | Checkbox |
| --- | ---------------------------------------- | ------ | -------- |
| 24  | [KV Cache](systems/microkv.py)           | 35 min | - [ ]    |
| 25  | [Paged Attention](systems/micropaged.py) | 40 min | - [ ]    |
| 26  | [Quantization](systems/microquant.py)    | 40 min | - [ ]    |
| 27  | [Beam](systems/microbeam.py)             | 35 min | - [ ]    |
...
| #   | Script                                            | Time   | Checkbox |
| --- | ------------------------------------------------- | ------ | -------- |
| 28  | [State Space Model](systems/microssm.py)          | 35 min | - [ ]    |
| 29  | [Gradient Checkpoint](systems/microcheckpoint.py) | 30 min | - [ ]    |
| 30  | [Parallelism](systems/microparallel.py)           | 30 min | - [ ]    |
...
| #   | Script                                       | Time   | Checkbox |
| --- | -------------------------------------------- | ------ | -------- |
| 31  | [Discretization](systems/microdiscretize.py) | 40 min | - [ ]    |
| 32  | [Complex SSM](systems/microcomplexssm.py)    | 40 min | - [ ]    |
| 33  | [Roofline](systems/microroofline.py)         | 40 min | - [ ]    |
...
| #   | Script                               | Time   | Checkbox |
| --- | ------------------------------------ | ------ | -------- |
| 34  | [MCTS](agents/micromcts.py)          | 90 min | - [ ]    |
| 35  | [React Agents](agents/microreact.py) | 90 min | - [ ]    |
